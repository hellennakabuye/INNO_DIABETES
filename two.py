...
def save_user_input(timestamp, age, sex, bmi, physical_activity, family_history, hypertension, diet_score, blood_glucose, predicted_risk):
    sheet.append_row([
...
if st.button("Predict Diabetes Risk"):
    ...
    save_user_input(datetime.now().strftime("%Y-%m-%d %H:%M:%S"), age, sex, bmi, physical_activity, family_history, hypertension, diet_score, blood_glucose, result)
